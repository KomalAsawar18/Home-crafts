...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ url('backend/images/favicon/browser.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ url('backend/images/favicon/browser.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ url('backend/images/favicon/browser.png') }}">
    <link rel="manifest" href="{{ url('backend/images/favicon/browser') }}">
        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/admin')}}">
                <div class="sidebar-brand-icon ">
                    <img src="{{ url('backend/images/logo/logo.png') }}" alt="logo" height="80px" width="100%"
            ...
            <li class="nav-item {{ Request::is('admin/reviews', 'admin/review-add') ? 'active':''}}">
                ...
                <div id="collapseReviews" class="collapse" aria-labelledby="reviews" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{url('/admin/review-add')}}">Add Review</a>
                    </div>
                </div>
            </li>
